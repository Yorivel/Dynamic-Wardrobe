...
You can customize which locations belong to which region by editing `Core/ContextMap.reds`. You can even create entirely new keywords beyond the four defaults.
