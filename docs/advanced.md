...
For exact control over a specific spot, press **F10** in-game to see your current location name (e.g. <code>Badlands&#x5F;RedPeaks</code>), then name an outfit using any word from that name. See [All Location Enums](location-enums.md) for the complete list.
